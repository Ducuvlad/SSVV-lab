...
public class Teme implements hasID<Integer> {
    ...
    public boolean equals(Object object2) {
        return object2 instanceof Teme && this.deadline.equals(((Teme) object2).deadline) && this.descriere.equals(((Teme) object2).descriere) && this.nr.equals(((Teme) object2).nr) && this.sapt_primire.equals(((Teme) object2).sapt_primire);
    }
}
